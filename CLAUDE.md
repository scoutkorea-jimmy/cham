...
docs/privacy-record.md  **개인정보 처리 기록** — 무엇을·왜·어디에·얼마나.
                    개인정보를 받는 칸을 늘리거나 외부 서비스를 붙이면 여기부터 고친다
...
| **개인정보를 더 받거나 외부 서비스를 붙일 때** | [docs/privacy-record.md](docs/privacy-record.md) — 처리 기록. 고친 뒤 `public/privacy.html` 과 대조한다 |
