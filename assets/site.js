...
(function () {
  ...
  function gosiBase(over) {
    var g = {
      pname: '', maker: '한국찬전통발효식품협동조합 (제조: 정선만장대)', country: '대한민국', origin: '국산 (강원 정선)',
  ...
  function buildNav() {
    ...
    return '<div class="nav"><div class="nav-inner">' +
        '<a class="brand" href="index.html" aria-label="홈으로">' +
          '<img src="assets/logo.png" alt="한국찬전통발효식품협동조합 로고">' +
          '<span class="bt"><b>한국찬전통발효식품</b><span>협동조합 · 孝</span></span>' +
        '</a>' +
  ...
  function buildFooter() {
    return '<div class="footer-inner">' +
      ...
      '<div class="footer-bottom">' +
        '<span>© 2026 한국찬전통발효식품협동조합. All rights reserved.</span>' +
